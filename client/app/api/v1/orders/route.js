...
export async function POST(req) {
  console.log("POST /api/v1/orders HIT");

  console.log("working");
  console.log("MATCHING ENGINE INSTANCE:", getMatchingEngine());
  ...
  try {
    ...
    return NextResponse.json({
      order: orderToJson(result.order, decimals),
      trades: result.trades.map((t) => tradeToJson(t, decimals))
    });
